...
public class Sprite
{
	...
	private final void readSpriteData(String var1, int var2)
	{
		try
		{
			byte count = 0;
			...
			InputStream is = Renderer.getResourceAsStream(var1 + ".sprite");
			...
			{
				is = Renderer.getResourceAsStream(var1 + ".sprbin");
			...
			try
			{
				SpriteFrame var6 = new SpriteFrame(var1, var2);
			...
			catch(Exception var13)
			{
				try
				{
					for(int var7 = 0; var7 < count; ++var7)
					{
						...
						{
							sfmTempFrames[var7] = new SpriteFrame(var8.toString(), var2);
						}
					}
				}
