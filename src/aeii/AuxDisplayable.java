...
public final class AuxDisplayable extends PaintableObject
{
	...
	public final void sub_1c3(int var1, int var2, byte[][] var3, Vector var4)
	{
		...
		boolean var5 = false;
		currentWidth = var_adc * currentMainDisplayable.var_99d[0].imgwidth + 8;
		currentHeight = var_b1c * currentMainDisplayable.var_99d[0].imgheight + 8;
		int var6;
		if(currentWidth > var1)
		{
			var6 = currentMainDisplayable.var_99d[0].imgwidth;
			var_a1a = (var1 - 8) / var6;
		...
		{
			var6 = currentMainDisplayable.var_99d[0].imgheight;
			var_a2b = (var2 - 8) / var6;
            ...
            label409:
				switch(mode)
				{
					...
					case 8:
						...
						var24 = currentMainDisplayable.var_99d[0].imgwidth;
						var25 = currentMainDisplayable.var_99d[0].imgheight;
						...
						for(var28 = var_9cc; var28 < var26; ++var28)
						{
							...
							{
								var30 = currentMainDisplayable.tilesTypes[var_a36[var29][var28]];
								if(var_a36[var29][var28] >= currentMainDisplayable.tilesCount)
								{
									var31 = (var_a36[var29][var28] - currentMainDisplayable.tilesCount) / 2;
									var30 = 2 * var31 + 8 + var30 - 8;
								}

								currentMainDisplayable.var_99d[var30].paint(g, locX, y);
								locX += var24;
							}
